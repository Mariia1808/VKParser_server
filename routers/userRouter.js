...
router.post('/searchUserUniversity/:token/:q/:sort/:fields/:sex/:age_from/:age_to/:group_id/:from_list/:university/:university_year/:university_faculty/:university_chair', userController.searchUserUniversity)
